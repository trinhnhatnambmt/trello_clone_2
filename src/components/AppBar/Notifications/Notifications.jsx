...
function Notifications() {
    ...
    useEffect(() => {
        ...
        const onReceiveNewInvitation = (invitation) => {
            // Nếu như thằng user đang đăng nhập hiện tại mà chúng ta lưu trong redux thì chính là thằng invitee trong bản ghi invitation
        ...
        <Box>
            <Tooltip title="Notifications">
                <Badge
                    ...
                    aria-controls={
                        open ? "basic-notification-drop-down" : undefined
                    }
                    aria-haspopup="true"
