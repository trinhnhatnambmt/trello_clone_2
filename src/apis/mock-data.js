export const mockData = {
    board: {
        ...
        columns: [
            ...
            /*
* Video 37.2: Cách xử lý bug logic thư viện Dnd-kit khi Column là rồng:
...
*** Kỹ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ ở học phần tích hợp API Back-end vào dự án. (bởi vì đây
là file mock-data)
            */
